...
const impl = {
   ...
   */
  getScriptText: (cloudPlatform = impl.cloudPlatform.aws, options) => {
...
module.exports = {
   ...
   * deployment.
   */
  deploy: (cloudPlatform = impl.cloudPlatform.aws, options) => impl.serverlessLoader(cloudPlatform)
    .then((serverless) => {
   ...
   */
  invoke: (cloudPlatform = impl.cloudPlatform.aws, options) => impl.getScriptText(cloudPlatform, options)
