...
const func = require(path.join('..', '..', '..', 'lib', 'gcf', 'func.js')) // eslint-disable-line import/no-dynamic-require
const task = require(path.join('..', '..', '..', 'lib', 'gcf', 'task.js')) // eslint-disable-line import/no-dynamic-require
const handler = require(path.join('..', '..', '..', 'lib', 'gcf', 'index.js')) // eslint-disable-line import/no-dynamic-require

const defaultSettings = func.def.getSettings()

describe('./lib/gcf/handler.js', () => {
  describe(':impl', () => {
    describe('#delay', () => {
      let setTimeoutStub
      beforeEach(() => {
